...
{name: "header-background-color", selector: ".gdlr-header-inner, .header-style-transparent .gdlr-fixed-header.gdlr-header-inner{ background-color: #gdlr#; }"},
{name: "main-navigation-text", selector: ".gdlr-main-menu > li > a, .header-style-transparent .gdlr-fixed-header.gdlr-header-inner .gdlr-main-menu > li > a{ color: #gdlr#; }"},
{name: "main-navigation-text-hover", selector: ".gdlr-main-menu > li:hover > a, .gdlr-main-menu > li.current-menu-item > a, .gdlr-main-menu > li.current-menu-ancestor > a, .header-style-transparent .gdlr-fixed-header.gdlr-header-inner .gdlr-main-menu > li:hover > a, .header-style-transparent .gdlr-fixed-header.gdlr-header-inner .gdlr-main-menu > li.current-menu-item > a, .header-style-transparent .gdlr-fixed-header.gdlr-header-inner .gdlr-main-menu > li.current-menu-ancestor > a{ color: #gdlr#; opacity: 1; filter: alpha(opacity=100); }"},
{name: "transparent-main-navigation-text", selector: ".header-style-transparent .gdlr-main-menu > li > a{ color: #gdlr#; }"},
{name: "transparent-main-navigation-text-hover", selector: ".header-style-transparent .gdlr-main-menu > li:hover > a, .header-style-transparent .gdlr-main-menu > li.current-menu-item > a, .header-style-transparent .gdlr-main-menu > li.current-menu-ancestor > a{ color: #gdlr#; opacity: 0.5; filter: alpha(opacity=50); }"},
...
{name: "blog-grid-background", selector: ".gdlr-blog-grid, .gdlr-blog-widget .post-header{ background-color: #gdlr#; }"},
{name: "blog-grid-info-color", selector: ".gdlr-blog-grid .blog-info, .gdlr-blog-grid .blog-info a, .gdlr-blog-grid .blog-info i, .gdlr-blog-widget .blog-info, .gdlr-blog-widget .blog-info a, .gdlr-blog-widget .blog-info i{ color: #gdlr#; }"},
{name: "blog-grid-read-more-text", selector: ".gdlr-blog-grid .gdlr-grid-read-more a{ color: #gdlr#; }"},
{name: "blog-grid-read-more-hover", selector: ".gdlr-blog-grid .gdlr-grid-read-more a:hover{ color: #gdlr#; }"},
...
{name: "portfolio-filter-button-active-background", selector: ".portfolio-item-filter a.active{ background-color: #gdlr#; } "},
